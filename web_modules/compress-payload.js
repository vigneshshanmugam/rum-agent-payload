...
function compress(payload, type = "gzip") {
...
async function decompress(cs, type = "gzip") {
...
export { bufferToString, compress, decompress, stringToBuffer, view };
